...
import com.introvd.template.xyui.ripple.C9174a;
...
public class RoundedTextView extends TextView {
    ...
    /* renamed from: b */
    private void m26600b(AttributeSet attributeSet, int i) {
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (this.eCw != null) {
            this.eCw.onSizeChanged(i, i2, i3, i4);
        }
    }
    ...
    public void setRippleColor(int i) {
        if (this.eCw != null) {
            this.eCw.setRippleColor(i);
        }
    }

    public void setRippleRoundedCorner(int i) {
        if (this.eCw != null) {
            this.eCw.setRippleRoundedCorners(i);
        }
    }
