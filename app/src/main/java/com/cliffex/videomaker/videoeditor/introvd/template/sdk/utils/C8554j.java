...
/* renamed from: com.introvd.template.sdk.utils.j */
public class C8554j {
    ...
    /* renamed from: d */
    public static void m25006d(String str, String str2) {
        if ((mlogLevel & 8) != 0) {
    ...
    /* renamed from: e */
    public static void m25007e(String str, String str2) {
        if ((mlogLevel & 1) != 0) {
            StringBuilder sb = new StringBuilder();
            sb.append(str);
            sb.append(":");
    ...
    /* renamed from: i */
    public static void m25008i(String str, String str2) {
        if ((mlogLevel & 4) != 0) {
            StringBuilder sb = new StringBuilder();
            sb.append(str);
            sb.append(":");
    ...
    /* renamed from: k */
    private static void m25009k(int i, String str, String str2) {
        if (i == 1) {
            Log.e(str, str2);
        } else if (i == 2) {
            Log.w(str, str2);
    ...
    public static void printFullLog(int i, String str, String str2) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            if (i2 == length - 1) {
                ...
                sb3.append(" ---> o(>_<)O ");
                m25009k(i, str, sb3.toString());
            }
        }
    }

    /* renamed from: v */
    public static void m25010v(String str, String str2) {
        if ((mlogLevel & 16) != 0) {
            StringBuilder sb = new StringBuilder();
            sb.append(str);
            sb.append(":");
