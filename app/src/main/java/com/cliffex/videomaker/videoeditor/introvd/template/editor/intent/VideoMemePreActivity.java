...
public class VideoMemePreActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        VivaRouter.getRouterBuilder(IntentHomeParams.URL).mo10400g(getIntent().getExtras()).mo10399f(GalleryRouter.GALLERY_EXTRA_INTENT_ACTION, getIntent().getAction()).mo10406h(GalleryRouter.EXTRA_INTENT_MODE_KEY, 2002).mo10398dD(67108864).mo10382H(this);
