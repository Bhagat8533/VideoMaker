...
/* renamed from: com.introvd.template.app.receiver.a */
public class C4129a extends C2611c {
    private static Handler mHandler;

    /* renamed from: com.introvd.template.app.receiver.a$a */
    private static class C4130a extends Handler {
        private WeakReference<Context> bvZ;

        public C4130a(Context context, Looper looper) {
            super(looper);
        ...
        public void handleMessage(Message message) {
            ...
            if (context != null && C4129a.m10262cx(context) && message.what == 0) {
                boolean z = true;
                try {
    ...
    /* renamed from: cv */
    private static void m10261cv(Context context) {
    ...
    /* renamed from: cx */
    public static boolean m10262cx(Context context) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: cy */
    public static void m10263cy(Context context) {
    ...
    public static synchronized void m10265j(android.content.Context r7, android.content.Intent r8) {
        /*
            java.lang.Class<com.introvd.template.app.receiver.a> r8 = com.introvd.template.app.receiver.C4129a.class
            monitor-enter(r8)
        ...
        L_0x004c:
            ...
            boolean r5 = m10262cx(r7)     // Catch:{ Exception -> 0x00db }
        ...
        L_0x0085:
            ...
            com.introvd.template.app.receiver.a$a r5 = new com.introvd.template.app.receiver.a$a     // Catch:{ Exception -> 0x00db }
        ...
        L_0x0094:
            ...
            m10261cv(r7)     // Catch:{ Exception -> 0x00db }
            goto L_0x00db
        L_0x00a2:
        ...
        L_0x00dd:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.introvd.template.app.receiver.C4129a.m10265j(android.content.Context, android.content.Intent):void");
    }

    public static void schedule() throws Exception {
        int bd = C2629h.m7603yN().mo13010bd("net_work_worker");
        StringBuilder sb = new StringBuilder();
        sb.append("Jamin cancelAllForTag count = ");
        sb.append(bd);
        LogUtilsV2.m14227d(sb.toString());
        new C2638b("net_work_worker").mo13066zm().mo13067zn().mo13058zi();
        LogUtilsV2.m14227d("Jamin schedule tag = net_work_worker");
    }

    /* access modifiers changed from: protected */
    /* renamed from: a */
    public C2614b mo12943a(C2613a aVar) {
        LogUtilsV2.m14227d("Jamin onRunJob");
        m10265j(getContext(), null);
