...
/* renamed from: com.introvd.template.ui.view.RotateTextView */
public class RotateTextView extends TextView {
    ...
    public RotateTextView(Context context, AttributeSet attributeSet) {
        ...
        this.ezn = obtainStyledAttributes.getBoolean(C10122R.styleable.RotateView_isShadowOn, false);
        aNe();
        this.cbA = obtainStyledAttributes.getInt(C10122R.styleable.RotateView_rotation, 0);
    ...
    public RotateTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mContext = context;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C10122R.styleable.RotateView);
        this.ezn = obtainStyledAttributes.getBoolean(C10122R.styleable.RotateView_isShadowOn, true);
        aNe();
        this.cbA = obtainStyledAttributes.getInt(C10122R.styleable.RotateView_rotation, 0);
        obtainStyledAttributes.recycle();
        update();
    ...
    /* renamed from: dS */
    public int mo35691dS(int i, int i2) {
        if (1 == i) {
            return i2 != 1 ? 0 : 0;
        }
        if (2 == i) {
        ...
        switch (this.ezk) {
            case 0:
                ...
                if (!z) {
                    ...
                    while (i6 <= i3) {
                        i6++;
                        canvas2.drawText(strArr[i6], (float) ((width / 2) + paddingLeft), ((((((float) mo35691dS(i3 + 1, i6)) * descent) / 2.0f) + f) + (descent / 2.0f)) - this.mPaint.descent(), this.mPaint);
                    }
                    break;
                } else {
                    ...
                    while (i7 <= i3) {
                        int i8 = i7 + 1;
                        canvas2.drawText(strArr[i7].trim(), (float) (strArr[i7].contains(" ") ? 50.0d - (((double) (strArr[i7].length() - i4)) * 6.5d) : 50.0d - (((double) strArr[i7].length()) * 6.5d)), ((((((float) mo35691dS(i3 + 1, i8)) * descent) / 2.0f) + f) + (descent / 2.0f)) - this.mPaint.descent(), this.mPaint);
                        i7 = i8;
                        i4 = 1;
                    }
                    break;
