...
/* renamed from: com.introvd.template.editor.preview.theme.b */
public class C6658b extends C1018h {
    private int cZQ;
    ...
    public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, C1031r rVar) {
        if (C4580b.m11666qi()) {
            if (recyclerView.mo7746aN(view) == recyclerView.getAdapter().getItemCount() - 1) {
