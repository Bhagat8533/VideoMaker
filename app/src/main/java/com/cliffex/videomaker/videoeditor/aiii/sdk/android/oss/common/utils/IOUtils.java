...
public class IOUtils {
    ...
    public static byte[] readStreamAsBytesArray(InputStream inputStream, int i) throws IOException {
        ...
        while (true) {
            ...
            int read = inputStream.read(bArr, 0, Math.min(2048, (int) (j2 - j)));
            if (read <= -1) {
                break;
            }
            byteArrayOutputStream.write(bArr, 0, read);
    ...
    public static java.lang.String readStreamAsString(java.io.InputStream r5, java.lang.String r6) throws java.io.IOException {
        ...
        L_0x003e:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.aiii.sdk.android.oss.common.utils.IOUtils.readStreamAsString(java.io.InputStream, java.lang.String):java.lang.String");
    }
