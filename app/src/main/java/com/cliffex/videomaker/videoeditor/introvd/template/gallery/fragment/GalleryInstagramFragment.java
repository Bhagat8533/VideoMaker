...
public class GalleryInstagramFragment extends AbstractGalleryFragment {
    ...
    /* renamed from: d */
    public static AbstractGalleryFragment m22090d(int i, boolean z, int i2) {
    ...
    public void mo32016a(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        this.bwy = layoutInflater.inflate(R.layout.gallery_fragment_instagram, viewGroup, false);
        ...
        C7447b bVar = new C7447b(getActivity(), C7444c.GALLERY_TAB_INSTAGRAM, this.dFm, this.dFn, this.dFp);
        this.dHD = bVar;
