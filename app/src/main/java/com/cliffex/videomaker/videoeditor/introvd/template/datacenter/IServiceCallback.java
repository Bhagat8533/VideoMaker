...
public interface IServiceCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IServiceCallback {
        private static final String DESCRIPTOR = "com.introvd.template.datacenter.IServiceCallback";
        static final int TRANSACTION_onServiceNotify = 1;
        ...
        private static class Proxy implements IServiceCallback {
            ...
            public void onServiceNotify(String str, int i, Bundle bundle) throws RemoteException {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                ...
                onServiceNotify(parcel.readString(), parcel.readInt(), parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
    ...
    void onServiceNotify(String str, int i, Bundle bundle) throws RemoteException;
}
