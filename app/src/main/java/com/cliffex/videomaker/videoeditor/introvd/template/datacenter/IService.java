...
public interface IService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IService {
        private static final String DESCRIPTOR = "com.introvd.template.datacenter.IService";
            ...
            if (i != 1598968902) {
                switch (i) {
                    case 1:
                        ...
                        registerCallback(com.introvd.template.datacenter.IServiceCallback.Stub.asInterface(parcel.readStrongBinder()));
                        parcel2.writeNoException();
                        return true;
                    case 2:
                        parcel.enforceInterface(str);
                        unregisterCallback(com.introvd.template.datacenter.IServiceCallback.Stub.asInterface(parcel.readStrongBinder()));
                        parcel2.writeNoException();
                        return true;
                    default:
