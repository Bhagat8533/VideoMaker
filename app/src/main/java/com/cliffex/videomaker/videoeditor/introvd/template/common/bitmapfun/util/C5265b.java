...
/* renamed from: com.introvd.template.common.bitmapfun.util.b */
class C5265b extends C5264a {
    ...
    /* renamed from: a */
    public Bitmap mo26543a(Bitmap bitmap, String str) {
        int i;
        int i2;
        int[] iArr;
        try {
