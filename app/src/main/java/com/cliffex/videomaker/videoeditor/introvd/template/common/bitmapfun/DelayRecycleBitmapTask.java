...
public class DelayRecycleBitmapTask {
    ...
    /* access modifiers changed from: private */
    /* renamed from: YZ */
    public static synchronized void m14280YZ() {
    ...
    public static synchronized void delayRecycle(android.graphics.Bitmap r4) {
        /*
            java.lang.Class<com.introvd.template.common.bitmapfun.DelayRecycleBitmapTask> r0 = com.introvd.template.common.bitmapfun.DelayRecycleBitmapTask.class
            monitor-enter(r0)
        ...
        L_0x002d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.introvd.template.common.bitmapfun.DelayRecycleBitmapTask.delayRecycle(android.graphics.Bitmap):void");
    }
            ...
            if (mHandler == null) {
                mHandler = new Handler(mHandlerThread.getLooper()) {
                    public void handleMessage(Message message) {
                        DelayRecycleBitmapTask.m14280YZ();
                        removeMessages(0);
